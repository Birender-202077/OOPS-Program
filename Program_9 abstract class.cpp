/*Write a program to create an abstract class named Shape that contains an empty method number of sides(). 
Provide three classes named Trapezoid, Triangle and Hexagon such that each of the classes contains only the 
method number of Sides() that shows the number of sides in the given geometrical figure.*/
